...
contract StarNotary is ERC721 {
    ...
    constructor() ERC721("StarNotary Token", "SNT") {
    }
    ...
    modifier isValidForExchange(uint256 _tokenId1, uint256 _tokenId2) {
        require(msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId2), "Caller is not owner");
        _;
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public isValidForExchange(_tokenId1, _tokenId2) {
        ...
        // Send token2 to user1
        transferFrom(tokenId2Owner, tokenId1Owner, _tokenId2);
    }

    // Implement Task 1 Transfer Stars
    function transferStar(address _to1, uint256 _tokenId) public isOwner(_tokenId) {
